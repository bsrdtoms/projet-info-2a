...
class HistoricalService:
    ...
    def get_user_history(self, user_id: int, limit: int = 50, offset: int = 0) -> List[HistoricalSearch]:
    ...
    def get_paginated_history(self, user_id: int, page: int = 1, per_page: int = 20) -> dict:
