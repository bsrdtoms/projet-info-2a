...
class WelcomeView(AbstractView):
    ...
    def display(self):
        ...
        print("2. Explore clusters (guest)")
    ...
    def create_account_flow(self):
        ...
        password = self.get_input("Password (min 6 characters): ")
    ...
    def login_flow(self):
        ...
        if success:
            ...
            UserView(user_service=self.user_service, user=user).menu_choice()
        else:
            input("\nPress Enter to continue...")
    ...
    def menu_choice(self):
        while True:
            ...
            if choice == "1":
                ...
                self.show_message("Clustering feature coming soon...")
                input("\nPress Enter to continue...")
            elif choice == "3":
